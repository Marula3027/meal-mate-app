...
export default function Header() {
  return (
    <header className="bg-[#a89673] text-white text-center py-6 font-(family-name:Times Roman) sticky top-0 z-50">
      <h1 className="text-5xl font-bold mb-4 font-serif header-title">MealMate</h1>

      <nav className="flex justify-center gap-8 text-lg header-nav">
